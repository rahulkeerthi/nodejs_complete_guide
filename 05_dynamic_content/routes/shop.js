...
router.get("/", (req, res, next) => {
	...
	// EJS
	res.render("shop", { prods: products, docTitle: "Shop", path: "/", productCSS: true, formsCSS: false }) // pass an object with data to render along with required handlebars data
})
